    ...
    return (
        <div className="flex flex-1 items-center gap-8 pb-4">
            <div className="grid grid-cols-6 w-full h-full justify-center gap-6 ">
                <div className={`flex items-center border ${darkMode ? 'border-zinc-700' : 'border-zinc-300'} transition-colors rounded-xl gap-4 overflow-hidden w-full justify-center border-l-5 border-b-5 border-l-lime-500 border-b-lime-500 col-span-3`}>
                ...
                <div className={`flex items-center border ${darkMode ? 'border-zinc-700' : 'border-zinc-300'} transition-colors rounded-xl gap-4 overflow-hidden w-full justify-center border-l-5 border-b-5 border-l-lime-500 border-b-lime-500 col-span-2`}>
                    <div className="flex flex-col items-center m-4">
            ...
            <div className={`flex flex-col w-[60%] items-center border ${darkMode ? 'border-zinc-700' : 'border-zinc-300'} rounded-xl pt-4 relative`}>
